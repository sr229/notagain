...
if CLIENT then
	...
	do
		...
		hook.Add("StartChat", "chatsounds_autocomplete_init", function()
			...
			hook.Add("OnChatTab", "chatsounds_autocomplete", function(str)
				...
				if found_autocomplete[1] then return found_autocomplete[1].val end
			end)
	...
	concommand.Add("saysound", function(ply, _, _, str)
		-- If the server has added the NetworkString
		if util.NetworkStringToID("newchatsounds") > 0 then
